...
var Countdown = {
  ...
  // Let's go !
  const cnt = Countdown;
  const second = Object.assign({}, Countdown);
  const burntax = Object.assign({}, Countdown);
  cnt.init('validator-countdown');
  second.init('eth-countdown');
  burntax.init('burntax-countdown');
